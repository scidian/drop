...
void LoadPaletteWindowThemes(Palette_Info &palette) {
    ...
    palette.colors.append( QColor::fromRgba( 0xFFFFFFFF ) );    //   0 Whites   (255, 255, 255)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    //   1 Blank
    palette.colors.append( QColor::fromRgba( 0xFFF2F2F2 ) );    //   2          (242, 242, 242)
    palette.colors.append( QColor::fromRgba( 0xFFD9D9D9 ) );    //   3          (217, 217, 217)
    palette.colors.append( QColor::fromRgba( 0xFFBFBFBF ) );    //   4          (191, 191, 191)
    palette.colors.append( QColor::fromRgba( 0xFFA6A6A6 ) );    //   5          (166, 166, 166)
    palette.colors.append( QColor::fromRgba( 0xFF7F7F7F ) );    //   6          (127, 127, 127)
    ...
    palette.colors.append( QColor::fromRgba( 0xFF7F7F7F ) );    //  18          (127, 127, 127)
    palette.colors.append( QColor::fromRgba( 0xFF595959 ) );    //  19          ( 89,  89,  89)
    palette.colors.append( QColor::fromRgba( 0xFF404040 ) );    //  20          ( 64,  64,  64)
    palette.colors.append( QColor::fromRgba( 0xFF262626 ) );    //  21          ( 38,  38,  38)
    palette.colors.append( QColor::fromRgba( 0xFF0D0D0D ) );    //  22          ( 13,  13,  13)
    ...
    palette.colors.append( QColor::fromRgba( 0xFFEEECE1 ) );    //  32 Browns   (238, 236, 225)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    //  33
    palette.colors.append( QColor::fromRgba( 0xFFDDD9C3 ) );    //  34          (221, 217, 195)
    palette.colors.append( QColor::fromRgba( 0xFFC4BD97 ) );    //  35          (196, 189, 151)
    palette.colors.append( QColor::fromRgba( 0xFF948A54 ) );    //  36          (148, 138,  84)
    palette.colors.append( QColor::fromRgba( 0xFF4A452A ) );    //  37          ( 74,  69,  42)
    palette.colors.append( QColor::fromRgba( 0xFF1E1C11 ) );    //  38          ( 30,  28,  17)
    ...
    palette.colors.append( QColor::fromRgba( 0xFF1F497D ) );    //  48 Blues    ( 31,  73, 125)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    //  49
    palette.colors.append( QColor::fromRgba( 0xFFC6D9F1 ) );    //  50          (198, 217, 241)
    palette.colors.append( QColor::fromRgba( 0xFF8EB4E3 ) );    //  51          (142, 180, 227)
    palette.colors.append( QColor::fromRgba( 0xFF558ED5 ) );    //  52          ( 85, 142, 213)
    palette.colors.append( QColor::fromRgba( 0xFF17375D ) );    //  53          ( 23,  55,  93)
    palette.colors.append( QColor::fromRgba( 0xFF0F243F ) );    //  54          ( 15,  36,  63)
    ...
    palette.colors.append( QColor::fromRgba( 0xFF4F81BD ) );    //  64 Gray Blues ( 79, 129, 189)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    //  65
    palette.colors.append( QColor::fromRgba( 0xFFDCE6F2 ) );    //  66          (220, 230, 242)
    palette.colors.append( QColor::fromRgba( 0xFFB9CDE5 ) );    //  67          (185, 205, 229)
    palette.colors.append( QColor::fromRgba( 0xFF95B3D7 ) );    //  68          (149, 179, 215)
    palette.colors.append( QColor::fromRgba( 0xFF376192 ) );    //  69          ( 55,  97, 146)
    palette.colors.append( QColor::fromRgba( 0xFF244061 ) );    //  70          ( 36,  64,  97)
    ...
    palette.colors.append( QColor::fromRgba( 0xFFC0504D ) );    //  80 Burnt Oranges (192,  80,  77)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    //  81
    palette.colors.append( QColor::fromRgba( 0xFFF2DCDB ) );    //  82          (242, 220, 219)
    palette.colors.append( QColor::fromRgba( 0xFFE6B9B8 ) );    //  83          (230, 185, 184)
    palette.colors.append( QColor::fromRgba( 0xFFD99694 ) );    //  84          (217, 150, 148)
    palette.colors.append( QColor::fromRgba( 0xFF953736 ) );    //  85          (149,  55,  54)
    palette.colors.append( QColor::fromRgba( 0xFF632523 ) );    //  86          ( 99,  37,  35)
    ...
    palette.colors.append( QColor::fromRgba( 0xFF9BBB59 ) );    //  96 Olive Drabs (155, 187,  89)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    //  97
    palette.colors.append( QColor::fromRgba( 0xFFEBF1DE ) );    //  98          (235, 241, 222)
    palette.colors.append( QColor::fromRgba( 0xFFD7E4BD ) );    //  99          (215, 228, 189)
    palette.colors.append( QColor::fromRgba( 0xFFC3D69B ) );    // 100          (195, 214, 155)
    palette.colors.append( QColor::fromRgba( 0xFF77933C ) );    // 101          (119, 147,  60)
    palette.colors.append( QColor::fromRgba( 0xFF4F6228 ) );    // 102          ( 79,  98,  40)
    ...
    palette.colors.append( QColor::fromRgba( 0xFF4F6228 ) );    // 112 Grayish Purples ( 79,  98,  40)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    // 113
    palette.colors.append( QColor::fromRgba( 0xFFE6E0EC ) );    // 114          (230, 224, 236)
    palette.colors.append( QColor::fromRgba( 0xFFCCC1DA ) );    // 115          (204, 193, 218)
    palette.colors.append( QColor::fromRgba( 0xFFB3A2C7 ) );    // 116          (179, 162, 199)
    palette.colors.append( QColor::fromRgba( 0xFF604A7B ) );    // 117          ( 96,  74, 123)
    palette.colors.append( QColor::fromRgba( 0xFF403152 ) );    // 118          ( 64,  49,  82)
    ...
    palette.colors.append( QColor::fromRgba( 0xFF4BACC6 ) );    // 128 Light Blues ( 75, 172, 198)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    // 129
    palette.colors.append( QColor::fromRgba( 0xFFDBEEF4 ) );    // 130          (219, 238, 244)
    palette.colors.append( QColor::fromRgba( 0xFFB7DEE8 ) );    // 131          (183, 222, 232)
    palette.colors.append( QColor::fromRgba( 0xFF93CDDD ) );    // 132          (147, 205, 221)
    palette.colors.append( QColor::fromRgba( 0xFF31859C ) );    // 133          ( 49, 133, 156)
    palette.colors.append( QColor::fromRgba( 0xFF215968 ) );    // 134          ( 33,  89, 104)
    ...
    palette.colors.append( QColor::fromRgba( 0xFFF79646 ) );    // 144 Oranges  (247, 150,  70)
    palette.colors.append( QColor::fromRgba( 0x00000000 ) );    // 145
    palette.colors.append( QColor::fromRgba( 0xFFFDEADA ) );    // 146          (253, 234, 218)
    palette.colors.append( QColor::fromRgba( 0xFFFCD5B5 ) );    // 147          (252, 213, 181)
    palette.colors.append( QColor::fromRgba( 0xFFFAC090 ) );    // 148          (250, 192, 144)
    palette.colors.append( QColor::fromRgba( 0xFFE46B0A ) );    // 149          (228, 107,  10)
    palette.colors.append( QColor::fromRgba( 0xFF984807 ) );    // 150          (152,  72,   7)
