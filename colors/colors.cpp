...
void LoadPalettes() {
    ...
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Seperator,        QColor(200, 200, 200)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Shadow,           QColor(225, 225, 225)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Background_Dark,  QColor(190, 190, 190)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Background_Light, QColor(175, 175, 175)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Button_Dark,      QColor(145, 145, 145)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Button_Light,     QColor(120, 120, 120)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Midlight,         QColor(100, 100, 100)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Text_Dark,        QColor( 40,  40,  40)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Text,             QColor( 25,  25,  25)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Text_Light,       QColor( 10,  10,  10)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Highlight,        QColor(  0,   0,   0)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Header_Text,      QColor( 10,  10,  10)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Header_Fade,      QColor(150, 150, 150)));
    ...
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Seperator,         QColor( 29,  77, 144)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Shadow,            QColor(  5,  16,  28)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Background_Dark,   QColor( 20,  55, 103)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Background_Light,  QColor( 29,  77, 144)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Button_Dark,       QColor( 12,  36,  61)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Button_Light,      QColor( 16,  48,  82)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Midlight,          QColor( 29,  77, 144)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Text_Dark,         QColor(106, 160, 216)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Text,              QColor(118, 180, 242)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Text_Light,        QColor(130, 200, 255)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Highlight,         QColor(212, 234, 254)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Header_Text,       QColor(  8,  24,  41)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Header_Fade,       QColor( 20,  55, 103)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Icon_Dark,         QColor(106, 160, 216)));
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Icon_Light,        QColor(118, 180, 242)));

    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Seperator,         QColor(166,  59,  31)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Shadow,            QColor( 39,  18,  11)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Background_Dark,   QColor(225, 167,  69)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Background_Light,  QColor(166,  59,  31)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Button_Dark,       QColor(233, 125,  49)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Button_Light,      QColor(200, 102,  34)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Midlight,          QColor(197,  79,  32)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Text_Dark,         QColor( 60,  31,  23)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Text,              QColor( 55,  26,  18)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Text_Light,        QColor( 50,  21,  13)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Highlight,         QColor(109,  95,  49)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Header_Text,       QColor(225, 167,  69)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Header_Fade,       QColor( 60,   9,   9)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Icon_Dark,         QColor( 90,  13,  13)));
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Icon_Light,        QColor(122,  18,  18)));
}
