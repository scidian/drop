...
void LoadPalettes() {
    ...
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Shadow,           QColor(250, 250, 250)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Seperator,        QColor(235, 235, 235)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Background_Dark,  QColor(220, 220, 220)));
    g_color_schemes[Color_Scheme::Light].insert(std::make_pair(Window_Colors::Background_Light, QColor(205, 205, 205)));
    ...
    g_color_schemes[Color_Scheme::Navy].insert(std::make_pair(Window_Colors::Header_Text,       QColor(177, 207, 254)));
    ...
    g_color_schemes[Color_Scheme::Rust].insert(std::make_pair(Window_Colors::Header_Text,       QColor(254, 179, 189)));
    ...
    g_color_schemes[Color_Scheme::Forest].insert(std::make_pair(Window_Colors::Shadow,          QColor(  7,   9,   6)));
    g_color_schemes[Color_Scheme::Forest].insert(std::make_pair(Window_Colors::Seperator,       QColor( 17,  23,  16)));
    g_color_schemes[Color_Scheme::Forest].insert(std::make_pair(Window_Colors::Background_Dark, QColor( 23,  32,  22)));
    g_color_schemes[Color_Scheme::Forest].insert(std::make_pair(Window_Colors::Background_Light,QColor( 32,  44,  31)));
    g_color_schemes[Color_Scheme::Forest].insert(std::make_pair(Window_Colors::Button_Dark,     QColor( 42,  59,  41)));
    g_color_schemes[Color_Scheme::Forest].insert(std::make_pair(Window_Colors::Button_Light,    QColor( 52,  72,  50)));
    g_color_schemes[Color_Scheme::Forest].insert(std::make_pair(Window_Colors::Midlight,        QColor( 66,  91,  64)));
    g_color_schemes[Color_Scheme::Forest].insert(std::make_pair(Window_Colors::Text_Dark,       QColor(106, 146, 103)));
    ...
    g_color_schemes[Color_Scheme::Royal].insert(std::make_pair(Window_Colors::Background_Dark,  QColor( 28,  23,  33)));
    g_color_schemes[Color_Scheme::Royal].insert(std::make_pair(Window_Colors::Background_Light, QColor( 61,  50,  71)));
    g_color_schemes[Color_Scheme::Royal].insert(std::make_pair(Window_Colors::Button_Dark,      QColor( 51,  41,  59)));
    g_color_schemes[Color_Scheme::Royal].insert(std::make_pair(Window_Colors::Button_Light,     QColor( 61,  50,  71)));
    g_color_schemes[Color_Scheme::Royal].insert(std::make_pair(Window_Colors::Midlight,         QColor( 79,  64,  91)));
    g_color_schemes[Color_Scheme::Royal].insert(std::make_pair(Window_Colors::Text_Dark,        QColor(125, 101, 144)));
