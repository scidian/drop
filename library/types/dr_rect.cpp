...
DrPoint DrRect::topRight()              { return DrPoint(left + width, top); }
DrPoint DrRect::bottomLeft()            { return DrPoint(left, top + height); }
DrPoint DrRect::bottomRight()           { return DrPoint(left + width, top + height); }
