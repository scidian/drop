...
void LoadPaletteRockyRover(Palette_Info &palette)
{
    ...
    palette.colors.append( QColor::fromRgba( 0xFF7599AA ) );    //  18
    palette.colors.append( QColor::fromRgba( 0xFF607D8B ) );    //  19
    palette.colors.append( QColor::fromRgba( 0xFF4A616C ) );    //  20
    ...
    palette.colors.append( QColor::fromRgba( 0xFF947465 ) );    //  33
    palette.colors.append( QColor::fromRgba( 0xFF745B4F ) );    //  34
    palette.colors.append( QColor::fromRgba( 0xFF5C483F ) );    //  35
    palette.colors.append( QColor::fromRgba( 0xFF463730 ) );    //  36
    ...
    palette.colors.append( QColor::fromRgba( 0xFF956959 ) );    //  50
    palette.colors.append( QColor::fromRgba( 0xFF795548 ) );    //  51
    palette.colors.append( QColor::fromRgba( 0xFF5A3F35 ) );    //  52
    ...
    palette.colors.append( QColor::fromRgba( 0xFFA98971 ) );    //  66
    palette.colors.append( QColor::fromRgba( 0xFF896F5C ) );    //  67
    palette.colors.append( QColor::fromRgba( 0xFF695546 ) );    //  68
    ...
    palette.colors.append( QColor::fromRgba( 0xFFAFA28A ) );    //  82
    palette.colors.append( QColor::fromRgba( 0xFF968B77 ) );    //  83
    palette.colors.append( QColor::fromRgba( 0xFF7D7463 ) );    //  84
    ...
    palette.colors.append( QColor::fromRgba( 0xFFE8D9AF ) );    //  98
    palette.colors.append( QColor::fromRgba( 0xFFCFBE91 ) );    //  99
    palette.colors.append( QColor::fromRgba( 0xFFB2A37C ) );    // 100
    ...
    palette.colors.append( QColor::fromRgba( 0xFFF1E9DA ) );    // 114
    palette.colors.append( QColor::fromRgba( 0xFFD9D1C4 ) );    // 115
    palette.colors.append( QColor::fromRgba( 0xFFBEB7AC ) );    // 116
    ...
    palette.colors.append( QColor::fromRgba( 0xFFA0EAEB ) );    // 130
    palette.colors.append( QColor::fromRgba( 0xFF8FCFD0 ) );    // 131
    palette.colors.append( QColor::fromRgba( 0xFF6CACAD ) );    // 132
    ...
    palette.colors.append( QColor::fromRgba( 0xFF947ECB ) );    // 139
    palette.colors.append( QColor::fromRgba( 0xFF7D6AAC ) );    // 140
