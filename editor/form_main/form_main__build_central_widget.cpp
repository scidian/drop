//
//      Created by Stephens Nunnally on 3/14/2019, (c) 2019 Scidian Studios, All Rights Reserved
//
//  File:
//
//
...
void FormMain::buildCentralWidgetSoundCreator() {
    ...
    // ***** Build central widgets
    m_widget_central_sound_creator = new QWidget();
    m_widget_central_sound_creator->setObjectName(QStringLiteral("widgetCentralSoundCreator"));
    m_widget_central_sound_creator->setSizePolicy(size_policy_preferred_horizontal);
        QVBoxLayout *vertical_layout_sound_creator = new QVBoxLayout(m_widget_central_sound_creator);
        vertical_layout_sound_creator->setSpacing(0);
        vertical_layout_sound_creator->setObjectName(QStringLiteral("verticalLayoutSoundCreator"));
        // This sets the border with for the main view area between middle and docks
        vertical_layout_sound_creator->setContentsMargins(0, 0, 0, 0);
