...
QVariant EditorItem::itemChange(GraphicsItemChange change, const QVariant &value) {
    ...
    if (change == ItemScenePositionHasChanged) {
        ...
        m_editor_relay->updateEditorWidgetsAfterItemChange(Editor_Widgets::View, { m_thing }, { std::make_pair(Comps::Thing_Transform, Props::Thing_Position) });
    ...
    if (change == ItemTransformHasChanged) {
        ...
        m_editor_relay->updateEditorWidgetsAfterItemChange(Editor_Widgets::View, { m_thing },
    ...
    if (change == ItemZValueHasChanged) {
        ...
        m_editor_relay->updateEditorWidgetsAfterItemChange(Editor_Widgets::View, { m_thing }, { std::make_pair(Comps::Thing_Layering, Props::Thing_Z_Order) });
        return new_z;
    }
