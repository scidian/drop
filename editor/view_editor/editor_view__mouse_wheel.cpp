//
//      Created by Stephens Nunnally on 1/21/2020, (c) 2020 Scidian Studios, All Rights Reserved
//
//  File:
//
//
    ...
    if (m_over_handle == Position_Flags::Over_Camera && m_cam_mouse_over != nullptr) {
        if (m_cam_mouse_over->isLocked() == false) {
            ...
            if (m_cam_mouse_over->getThingType() == DrThingType::Character) {
                ...
                m_editor_relay->updateEditorWidgetsAfterItemChange( Editor_Widgets::View, { m_cam_mouse_over },
