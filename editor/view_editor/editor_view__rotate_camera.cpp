//
//      Created by Stephens Nunnally on 1/15/2020, (c) 2020 Scidian Studios, All Rights Reserved
//
//  File:
//
//
...
void EditorView::rotateCamera(QPointF mouse_in_view) {
    ...
    if (m_cam_selected->getThingType() == DrThingType::Character) {
        ...
        m_editor_relay->updateEditorWidgetsAfterItemChange( Editor_Widgets::View, { m_cam_selected },
