...
QFrame* TreeInspector::createImageFrame(DrProperty *property, QFont &font, QSizePolicy size_policy) {
    ...
    if (animation != nullptr) {
        ...
        delete_button->setObjectName("buttonImageMiniButton");
            ...
            delete_icon = QPixmap::fromImage( DrImaging::ColorizeImage(delete_icon.toImage(), Dr::ToQColor(Dr::GetColor(Window_Colors::Text))) );
        ...
        edit_button->setObjectName("buttonImageMiniButton");
            ...
            edit_icon = QPixmap::fromImage( DrImaging::ColorizeImage(edit_icon.toImage(), Dr::ToQColor(Dr::GetColor(Window_Colors::Text))) );
