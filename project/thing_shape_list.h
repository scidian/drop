...
private:
    ...
    std::list<std::vector<DrPoint>>     m_polygons { };             // List of polygon shapes
...
public:
    ...
    // Shape Functions
    void        addPolygon(std::vector<DrPoint> point_list);

    // Getters / Setters
    double&                             getDirection() { return m_direction; }
    One_Way&                            getOneWayType() { return m_one_way; }
    std::list<std::vector<DrPoint>>&    getPolygons() { return m_polygons; }
