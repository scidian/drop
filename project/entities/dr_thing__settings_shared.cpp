...
void DrThing::addComponentMovement() {
    ...
    addPropertyToComponent(Components::Thing_Movement, Properties::Thing_Velocity_X, Property_Type::Variable, DrPointF(0, 0),
    ...
    addPropertyToComponent(Components::Thing_Movement, Properties::Thing_Velocity_Y, Property_Type::Variable, DrPointF(0, 0),
                           "Vertical",  "Initial vertical movement speed of Object, +/- variable amount.  <br><br> "
                                        "<b>NOTE:</b> Object Type must be <b>Kinematic</b> or <b>Dynamic</b> to use this setting!", false, false);
    addPropertyToComponent(Components::Thing_Movement, Properties::Thing_Spin_Velocity, Property_Type::Variable, DrPointF(0, 0),
...
void DrThing::addComponentSpawn() {
    ...
    addPropertyToComponent(Components::Thing_Spawn, Properties::Thing_Spawn_Rate, Property_Type::Variable, DrPointF(1, 0),
    ...
    addPropertyToComponent(Components::Thing_Spawn, Properties::Thing_Spawn_Offset_X, Property_Type::Variable, DrPointF(0, 0),
                           "Spawn Offset X", "This is a X offset for use with spawning, +/- variable amount. "
                                             "Useful for some randomess to object location.");
    addPropertyToComponent(Components::Thing_Spawn, Properties::Thing_Spawn_Offset_Y, Property_Type::Variable, DrPointF(0, 0),
...
void DrThing::addComponent3D() {
    ...
    addPropertyToComponent(Components::Thing_3D, Properties::Thing_3D_X_Axis_Rotation, Property_Type::Variable, DrPointF(0, 0),
                           "Rotation X", "Starting rotation of object on the X Axis, +/- variable amount. Does not affect physics collision shape.");
    addPropertyToComponent(Components::Thing_3D, Properties::Thing_3D_Y_Axis_Rotation, Property_Type::Variable, DrPointF(0, 0),
                           "Rotation Y", "Starting rotation of object on the Y Axis, +/- variable amount. Does not affect physics collision shape.");
    addPropertyToComponent(Components::Thing_3D, Properties::Thing_3D_X_Axis_Speed, Property_Type::Variable, DrPointF(0, 0),
                           "Rotate Speed X", "Rotational speed of object on the X Axis, +/- variable amount. Does not affect physics collision shape.");
    addPropertyToComponent(Components::Thing_3D, Properties::Thing_3D_Y_Axis_Speed, Property_Type::Variable, DrPointF(0, 0),
...
void DrThing::addComponentAppearance(bool bitrate_and_pixel_only, bool show_component) {
    ...
    addPropertyToComponent(Components::Thing_Appearance, Properties::Thing_Filter_Bitrate, Property_Type::Slider, std::vector<DrVariant>({256, 0, 256, 8, ""}),
    ...
    addPropertyToComponent(Components::Thing_Appearance, Properties::Thing_Filter_Pixelation, Property_Type::PositiveSizeF, DrPointF(1.0, 1.0),
                           "Pixelation", "Size of x and y pixels, larger numbers provide more pixelation.");
    bool hidden = bitrate_and_pixel_only;
    addPropertyToComponent(Components::Thing_Appearance, Properties::Thing_Filter_Brightness, Property_Type::Slider, std::vector<DrVariant>({0, -255, 255, 5, ""}),
                           "Brightness", "How light / dark this item should appear. \nDefault: \t0 \nRange: \t-255 to 255", hidden);
    addPropertyToComponent(Components::Thing_Appearance, Properties::Thing_Filter_Contrast, Property_Type::Slider, std::vector<DrVariant>({0, -255, 255, 5, ""}),
                           "Contrast", "Amount of distinguishable difference of colors. \nDefault: \t0 \nRange: \t-255 to 255", hidden);
    addPropertyToComponent(Components::Thing_Appearance, Properties::Thing_Filter_Saturation, Property_Type::Slider, std::vector<DrVariant>({0, -255, 255, 5, ""}),
                           "Saturation", "How colorful the colors appear. \nDefault: \t0 \nRange: \t-255 to 255", hidden);
    addPropertyToComponent(Components::Thing_Appearance, Properties::Thing_Filter_Hue, Property_Type::Slider, std::vector<DrVariant>({0, 0, 360, 5, ""}),
