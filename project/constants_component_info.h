...
namespace Component_Icons {
    ...
    // Sound Components
    const std::string Sound             { std::string(":/assets/inspector_icons/comp_sound.png") };
    const std::string Sound_Effect      { std::string(":/assets/inspector_icons/comp_sound_effect.png") };
    const std::string Sound_Filter      { std::string(":/assets/inspector_icons/comp_sound_filter.png") };
    const std::string Sound_Noise       { std::string(":/assets/inspector_icons/comp_sound_noise.png") };
    const std::string Sound_Speech      { std::string(":/assets/inspector_icons/comp_sound_speech.png") };
    const std::string Sound_Wave        { std::string(":/assets/inspector_icons/comp_sound_wave.png") };
};
